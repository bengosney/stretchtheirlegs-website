module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass_globbing: {
      sass: {
        files: {
          "scss/_imports.scss": ["scss/*/**/*.scss", "!scss/external/**/*.scss", "!scss/mixins/**/*.scss"],
        },
        options: {
      ...
      external: {
        files: {
          "scss/_external.scss": ["scss/external/**/*.scss"],
        },
        options: {
    ...
    browserSync: {
      dev: {
        bsFiles: {
          src: ["stl/static/**/*.css", "stl/static/**/*.js", "templates/**.html", "pages/**/*.html", "./**/.html"],
        },
        options: {
          watchTask: true,
  ...
  grunt.registerTask("compile", [/*"fav",*/ "icons", "css", "js"]);
